...
public class DeckT : MonoBehaviourPunCallbacks
{
    ...
    private BoardCheckT boardCheckScript;
    ...
    void Start()
    {
        boardCheckScript = FindObjectOfType<BoardCheckT>();
    ...
    {
        Debug.Log("DeckT: Draw coroutine started with " + x + " cards to draw.");
        for (int i = 0; i < x; i++)
        {
